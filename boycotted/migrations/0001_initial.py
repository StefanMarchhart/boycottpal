# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-14 21:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boycotter', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Boycotted',
            fields=[
                ('boycotted_id', models.AutoField(primary_key=True, serialize=False, verbose_name='Boycotted ID')),
